...
class EmailVerificationService {
    static sendVerificationEmail(user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield client_1.default.emailVerification.create({
                data: {
                    userId: user.id,
                    token,
    ...
    static verifyEmail(token) {
        return __awaiter(this, void 0, void 0, function* () {
            const verification = yield client_1.default.emailVerification.findUnique({
                where: { token },
                include: { user: true },
            });
    ...
    static resendVerificationEmail(user) {
        return __awaiter(this, void 0, void 0, function* () {
            const lastVerification = yield client_1.default.emailVerification.findFirst({
